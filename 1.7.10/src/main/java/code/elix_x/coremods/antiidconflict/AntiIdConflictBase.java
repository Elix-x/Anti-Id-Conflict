...
@Mod(modid = "antiidconflict", name = "Anti Id Conflict", version = "1.1", dependencies = "required-after:excore")
public class AntiIdConflictBase /*extends DummyModContainer*/{
	...
	//	public static boolean overrideIDs;

	/*private static ModMetadata getModMeta() {
		ModMetadata meta = new ModMetadata();
		meta.modId = "antiidconflict";
		meta.name = "Anti Id Conflict";
		meta.version = "1.0";
		meta.authorList.add("elix_x");
		meta.credits = "elix_x";
